...
export function canAccess(role, module) {
  const permissions = {
    full_admin: ["projects", "audit", "dashboard", "reports", "chat", "showcase", "settings", "users"],
    analyst:    ["audit", "dashboard", "reports", "chat", "showcase"],
    client:     ["dashboard", "reports", "chat", "showcase"],
  };
