...
export async function fetchOptions() {
  ...
  const { data, error } = await supabase.from("dropdown_options").select("category, value, sort_order").order("sort_order", { ascending: true });
...
export const CATEGORY_LABELS = {competitor:"Competitors",category:"Category",year:"Year",type:"Content Type",entryDoor:"Entry Door",experienceReflected:"Experience Reflected",portrait:"Portrait",richnessDefinition:"Richness Definition",journeyPhase:"Journey Phase",momentAcquisition:"Acquisition Moments",momentDeepening:"Deepening Moments",momentUnexpected:"Unexpected Moments",clientLifecycle:"Client Lifecycle",bankRole:"Bank Role",painPointType:"Pain Point Type",languageRegister:"Language Register",channel:"Channel",cta:"Call to Action",toneOfVoice:"Tone of Voice",representation:"Representation",industryShown:"Industry",businessSize:"Business Size",brandArchetype:"Brand Archetype",diffClaim:"Differentiation Claim",executionStyle:"Execution Style",rating:"Rating",categoryProximity:"Category Proximity",companyType:"Company Type"};

export const SHARED_SECTIONS = [
  {title:"A. Identification",fields:[{key:"competitor",label:"Competitor",type:"select",localOnly:true},{key:"brand",label:"Brand",type:"text",globalOnly:true},{key:"country",label:"Country / Market",type:"text",globalOnly:true},{key:"category",label:"Category",type:"select"},{key:"category_proximity",label:"Category Proximity",type:"select",optKey:"categoryProximity",globalOnly:true},{key:"company_type",label:"Company Type",type:"select",optKey:"companyType",globalOnly:true},{key:"description",label:"Description",type:"text"},{key:"year",label:"Year",type:"select"},{key:"type",label:"Type",type:"select"},{key:"url",label:"URL",type:"text"},{key:"image_url",label:"Image URL",type:"text"},{key:"main_slogan",label:"Main Slogan",type:"text"},{key:"transcript",label:"Transcript",type:"textarea"}]},
  {title:"B. Creative Evaluation",fields:[{key:"synopsis",label:"Synopsis",type:"textarea"},{key:"insight",label:"Insight (human truth)",type:"textarea"},{key:"idea",label:"Idea (creative concept)",type:"textarea"},{key:"primary_territory",label:"Primary Territory",type:"text"},{key:"secondary_territory",label:"Secondary Territory",type:"text"},{key:"execution_style",label:"Execution Style",type:"select",optKey:"executionStyle"},{key:"rating",label:"Rating (1-5)",type:"select",optKey:"rating"},{key:"analyst_comment",label:"Analyst Comment",type:"textarea"}]},
  {title:"C. Entrepreneur Identity",fields:[{key:"entry_door",label:"Entry Door",type:"select",optKey:"entryDoor"},{key:"experience_reflected",label:"Experience",type:"select",optKey:"experienceReflected"},{key:"portrait",label:"Portrait",type:"select"},{key:"richness_definition",label:"Richness Definition",type:"select",optKey:"richnessDefinition"}]},
  {title:"D. Business Journey",fields:[{key:"journey_phase",label:"Phase",type:"select",optKey:"journeyPhase"},{key:"client_lifecycle",label:"Lifecycle",type:"select",optKey:"clientLifecycle"},{key:"moment_acquisition",label:"Acquisition Moment",type:"select",optKey:"momentAcquisition"},{key:"moment_deepening",label:"Deepening Moment",type:"select",optKey:"momentDeepening"},{key:"moment_unexpected",label:"Unexpected Moment",type:"select",optKey:"momentUnexpected"}]},
  {title:"E. Brand & Communication",fields:[{key:"bank_role",label:"Bank Role",type:"select",optKey:"bankRole"},{key:"pain_point_type",label:"Pain Point Type",type:"select",optKey:"painPointType"},{key:"pain_point",label:"Pain Point",type:"text"},{key:"language_register",label:"Language Register",type:"select",optKey:"languageRegister"},{key:"main_vp",label:"Main VP",type:"text"},{key:"brand_attributes",label:"Brand Attributes",type:"text"},{key:"emotional_benefit",label:"Emotional Benefit",type:"text"},{key:"rational_benefit",label:"Rational Benefit",type:"text"},{key:"r2b",label:"R2B",type:"text"}]},
  {title:"F. Execution",fields:[{key:"channel",label:"Channel",type:"select"},{key:"cta",label:"CTA",type:"select"},{key:"tone_of_voice",label:"Tone",type:"select",optKey:"toneOfVoice"},{key:"representation",label:"Representation",type:"select"},{key:"industry_shown",label:"Industry",type:"select",optKey:"industryShown"},{key:"business_size",label:"Size",type:"select",optKey:"businessSize"},{key:"brand_archetype",label:"Archetype",type:"select",optKey:"brandArchetype"},{key:"diff_claim",label:"Differentiation",type:"select",optKey:"diffClaim"}]},
];
