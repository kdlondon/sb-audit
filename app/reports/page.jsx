...
SLIDE 4: type:"cs_proof_points" — creative_proposition (same as slide 3), primary_proof (1-2 sentences), secondary_proofs (array of 3 strings), communication_focus (1-2 sentences), tone_voice (array of 3 labels), entries (array of 2-3 entries: {description, image_url, url, year} — pieces that prove the positioning)
SLIDE 5: type:"cs_product" — approach (one sentence), key_messages (array of 3), channels_formats (string), gap (one sentence insight), entries (array of 2-3 Product entries: {description, image_url, url, year})
SLIDE 6: type:"cs_beyond_banking" — beyond_banking (one paragraph), innovation (one paragraph), white_space (one sentence insight), entries (array of 1-2 Innovation/Beyond Banking entries: {description, image_url, url, year})
