...
const COUNTRIES = [
  ...
  {code:"CO",name:"Colombia"},{code:"AR",name:"Argentina"},{code:"PE",name:"Peru"},
  {code:"EC",name:"Ecuador"},{code:"VE",name:"Venezuela"},{code:"BO",name:"Bolivia"},
  {code:"PY",name:"Paraguay"},{code:"UY",name:"Uruguay"},{code:"CR",name:"Costa Rica"},
  ...
  {code:"PT",name:"Portugal"},{code:"NO",name:"Norway"},{code:"DK",name:"Denmark"},
  {code:"FI",name:"Finland"},{code:"PL",name:"Poland"},{code:"BE",name:"Belgium"},
  {code:"AT",name:"Austria"},{code:"CZ",name:"Czech Republic"},{code:"RO",name:"Romania"},
  {code:"HU",name:"Hungary"},{code:"GR",name:"Greece"},{code:"HR",name:"Croatia"},
  {code:"RS",name:"Serbia"},{code:"BG",name:"Bulgaria"},
  {code:"TH",name:"Thailand"},{code:"VN",name:"Vietnam"},{code:"PH",name:"Philippines"},
  {code:"MY",name:"Malaysia"},{code:"ID",name:"Indonesia"},{code:"TW",name:"Taiwan"},
  ...
  {code:"GH",name:"Ghana"},{code:"MA",name:"Morocco"},{code:"TN",name:"Tunisia"},
  ...
  {code:"LB",name:"Lebanon"},{code:"TR",name:"Turkey"},{code:"RU",name:"Russia"},
