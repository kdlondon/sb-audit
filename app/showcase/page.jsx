            ...
            <div className="space-y-1">
              {editSlides.map((slide, idx) => (<>
                ...
                <div key={idx} className="bg-surface border border-main rounded-xl overflow-hidden">
                  ...
                  {/* Live preview */}
                  <div className="w-[420px] flex-shrink-0 border-l border-main relative overflow-hidden" style={{backgroundColor:getThemeForSlide(slide,idx).bg}}>
                    <div className="absolute inset-0 flex items-center justify-center p-4" style={{transform:"scale(0.42)",transformOrigin:"center center"}}>
