              ...
              {editSlides.map((slide, idx) => (<>
                ...
                {idx > 0 && (
                  <button key={`add-${idx}`} onClick={() => {
                    ...
                    setEditSlides(s);
                  }} className="w-full py-1.5 text-muted hover:text-accent text-lg transition flex items-center justify-center gap-2 group">
                    <div className="h-px flex-1 bg-transparent group-hover:bg-[var(--accent)] transition opacity-30"/>
                    <span className="opacity-0 group-hover:opacity-100 transition text-sm">+</span>
                    <div className="h-px flex-1 bg-transparent group-hover:bg-[var(--accent)] transition opacity-30"/>
                  </button>
                )}
